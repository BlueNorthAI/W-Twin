...
const inventory = [

  {
    ...
    orderlinesperhour: <Chart1 data={chartData4} />,
    costperorderline: <Chart1 data={chartData5} />,
  },
  {
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-center ">Blue Collar Productivity</TableHead>
                <TableHead className="text-center">Labor Cost</TableHead>
                <TableHead className="text-center">Total Cost</TableHead>
                <TableHead className="text-center">Orderlines per Hour</TableHead>
                <TableHead className="text-center">Cost per Orderline</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {inventory.map((invoice) => (
                <TableRow key={invoice.name} >
                  ...
                  <TableCell className=" text-center">{invoice.orderlinesperhour}</TableCell>
                  <TableCell className="text-center">{invoice.costperorderline}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
