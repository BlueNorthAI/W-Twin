...
const invoices2 = [
  {
    equipmentType: 'Forklift',
    unitsRequiredForReceiving: '49',
    opex: '490,000'
  },
  {
    equipmentType: 'Ramp',
    unitsRequiredForReceiving: '28',
    opex: '280,000'
  },
      ...
      <div className="m-2">
        <div className="flex items-center justify-center  rounded-t-lg bg-gradient-to-t from-indigo-400 via-cyan-400 to-sky-500 shadow-lg p-0.5">
          <div className=" flex items-center w-full justify-between bg-sky-50  border rounded-t-lg text-2xl text-blue-900 font-bold">
            <div className="p-2">Shipping - Equipment Assessment</div>
          </div>
        </div>
              ...
              <DemoContainer>
                <Card className=" text-blue-900">
                  ...
                  <CardContent className="grid  gap-4 space-y-6">
                    <p>
                      ▪ A total of 49 forklifts are required in the shipping
                      process (loading of the trucks primarily)
                    </p>

                    <p>
                      ▪ An estimated 28 ramps (also known as dock doors) are
                      required to load outbound trucks
                    </p>
                  </CardContent>
                </Card>
              </DemoContainer>
