...
const invoices = [
  ...
  {
    equipmentType: 'Highbay Rack',
    warehouseOperationDaysPerYear: '300',
    warehouseOperationHoursPerDay: '16',
    unitPrice: '322'
  },
  {
    equipmentType: 'Highbay Forklift',
    warehouseOperationDaysPerYear: '300',
    warehouseOperationHoursPerDay: '16',
    unitPrice: '58,044'
  },
...
const invoices2 = [
  {
    equipmentType: 'Forklift',
    unitsRequiredForReceiving: '14.32',
    opex: '134,000'
  },
  {
    equipmentType: 'Highbay Rack',
    unitsRequiredForReceiving: '19,416.00',
    opex: '955,000'
  },
  {
    equipmentType: 'Highbay Forklift',
    unitsRequiredForReceiving: '11.22',
    opex: '203,000'
  }
];
      ...
      <div className="m-2">
        <div className="flex items-center justify-center  rounded-t-lg bg-gradient-to-t from-indigo-400 via-cyan-400 to-sky-500 shadow-lg p-0.5">
          <div className=" flex items-center w-full justify-between bg-sky-50  border rounded-t-lg text-2xl text-blue-900 font-bold">
            <div className="p-2">Storage - Equipment Assessment</div>
          </div>
        </div>
              ...
              <DemoContainer>
                <Card className=" text-blue-900">
                  ...
                  <CardContent className="grid  gap-4 space-y-6">
                    <p>
                      ▪ A total of 14 forklifts are required in the storage
                      process (from the receiving dock to the racks and from the
                      rack area to the shipping docks)
                    </p>

                    <p>
                      ▪ 11 highbay forklifts are needed to pick full pallets
                      within the highbay racks
                    </p>
                  </CardContent>
                </Card>
              </DemoContainer>
